...
function Header() {
	const { setCartOpened, getTotalPrice } = useContext(AppContext);
	const totalPrice = getTotalPrice();
	return (
		<header className="d-flex justify-between align-center p-40">
			<div className="headerLeft">
				<img height={40} width={40} src="./images/logo.png" alt="logo" />
				<div>
			...
			<ul className="headerRight">
				<li className="mr-30 d-flex align-center cu-p" onClick={setCartOpened}>
					<svg
						width="18"
						height="18"
						viewBox="0 0 20 20"
				...
				<Link to="/profile" className="cu-p">
					<svg
						width="18"
						height="18"
						viewBox="0 0 20 20"
